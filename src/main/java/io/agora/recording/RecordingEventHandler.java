...
public interface RecordingEventHandler {
   ...
   *
   * @param reason The reasons why the recording application leaves the channel. See {@link io.agora.recording.common.Common#LEAVE_PATH_CODE LEAVE_PATH_CODE}.
   */
  ...
  /** This callback is triggered when the recording application successfully joins the specified
  ...
  /** This callback is triggered when the recording application rejoins the channel after being disconnected due to network problems.
   *
   * When the recording application loses connection with the server because of network problems, the SDK automatically tries to reconnect and triggers this callback upon reconnection.
   *
   * @param channelId The channel name.
   *
   * @param uid The `uid` of the recording application.
   */
  ...
  /** Occurs when the recording application successfully registers a user account by calling the {@link RecordingSDK.createChannelWithUserAccount createChannelWithUserAccount} method. This callback reports the user ID and user account of the recording application.
   * 
   * @param uid The `uid` of the recording application.
   * @param userAccount The user account of the recording application. 
   */
