...
public class Common{
  ...
  */
  ...
  /** The statistics of the remote video stream. For details, see <a href="https://docs.agora.io/en/Interactive%20Broadcast/in_call_statistics_android?platform=Android#video-statistics-of-the-remote-users">Video Statistics of the Remote Users</a>. */
  ...
  /** The statistics of the remote audio stream. For details, see <a href="https://docs.agora.io/en/Interactive%20Broadcast/in_call_statistics_android?platform=Android#audio-statistics-of-the-remote-users">Audio Statistics of the Remote Users</a>. */
  ...
  public class RecordingStats {
    /** The length of time (s) when the recording application is in the channel, represented by an aggregate value. */
     ...
     * <ul>
     *   <li>Communication profile: userCount = The number of users in the channel (including the recording application). </li>
  ...
  public class LiteraWatermarkConfig {
     ...
     * @note
     * <ul>
     * <li>Supports English and Chinese characters.</li>
     * <li>Supports line breaks and word wrap. </li>
     * </ul>
     */
